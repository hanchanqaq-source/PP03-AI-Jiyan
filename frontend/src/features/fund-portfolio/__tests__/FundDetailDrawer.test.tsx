...
import type { FundAnalysis, FundHolding } from "@/lib/api";
...
const holding: FundHolding = {
  code: "000001", shares: 500, avg_cost: 2, buy_date: "2026-01-01", notes: "观察",
...
it("shows all five evidence regions and separates system from user tags", () => {
  render(<FundDetailDrawer open holding={holding} analysis={analysis} onClose={() => {}} />);
  for (const title of ["基本资料", "净值与历史表现", "公开持仓披露", "行业和产业链暴露", "数据质量"]) {
