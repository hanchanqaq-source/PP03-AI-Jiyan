...
export function NewsRiskSection({ trusted, candidate, windowDays, onWindowDaysChange, index = "08" }: {
  ...
  return <ReportSection id="news-risk" index={index} title="新闻、催化与风险" eyebrow="Catalysts and risks">
